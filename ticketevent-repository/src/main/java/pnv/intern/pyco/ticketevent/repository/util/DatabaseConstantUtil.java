...
public class DatabaseConstantUtil {
	...
	public static final String EVENT_FIELD_ORGANIZE_LOGO = "ORGANIZE_LOGO";
	...
	public static final String EVENT_FIELD_CONFIRM_EMAIL = "CONFIRM_EMAIL";
	...
	// EVENT_LAYOUT table
	public static final String EVENT_LAYOUT_TABLE = "EVENT_LAYOUT";
	...
	public static final String TICKET_FIELD_IS_FREE = "IS_FREE";
	...
	// TICKET_ORDER table
	public static final String TICKET_ORDER_TABLE = "TICKET_ORDER";
	public static final String TICKET_ORDER_FIELD_ID = "ID";
	public static final String TICKET_ORDER_FIELD_TICKET_ID = "TICKET_ID";
	public static final String TICKET_ORDER_FIELD_TICKET_BUYER_ID = "TICKET_BUYER_ID";
	public static final String TICKET_ORDER_FIELD_QUATITY = "QUANTITY";
	public static final String TICKET_ORDER_FIELD_BUY_DATE = "BUY_DATE";
	public static final String TICKET_ORDER_FIELD_STATUS = "STATUS";
	...
	public static final String MUSIC_LAYOUT_FIELD_BANNER_IMAGE = "BANNER_IMAGE";
	...
	public static final String MUSIC_LAYOUT_FAMOUS_PERSON_FIELD_INTRODUCTION = "INTRODUCTION";
