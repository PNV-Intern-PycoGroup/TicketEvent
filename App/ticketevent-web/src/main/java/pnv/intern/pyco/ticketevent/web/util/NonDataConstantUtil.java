...
public class NonDataConstantUtil {
	public static final String[] LIST_CITY_VIETNAM = {
		"TP Hà Nội", "TP Đà Nẵng", "TP Hồ Chí Minh", "TP Hải Phòng", "TP Cần Thơ", "An Giang", "Bà Rịa - Vũng Tàu", "Bắc Giang", "Bắc Kạn",
		...
		"Long An", "Nam Định", "Nghệ An", "Ninh Bình", "Ninh Thuận", "Phú Thọ", "Quảng Bình", "Quảng Nam", "Quảng Ngãi", "Quảng Ninh",
	...
	public static final String[] LIST_HOURS = {
