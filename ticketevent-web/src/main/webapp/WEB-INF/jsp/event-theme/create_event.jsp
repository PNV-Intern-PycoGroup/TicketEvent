...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/lib/animate.css">
		...
		<header>
			<nav class="navbar navbar-default navbar-fixed-top">
				<ul class="nav nav-pills header-control-step" role="tablist">
					<li class="active"><a class="a-header" href="#ticket-info" aria-controls="ticket-info" role="tab" data-toggle="tab"><spring:message code="step1.label.menu.eventInfo"/></a></li>
					<li><a class="a-header" href="#ticket-layout" aria-controls="ticket-layout" role="tab" data-toggle="tab"><spring:message code="step1.label.menu.webStructure"/></a></li>
					<li><a class="a-header" href="#ticket-setting" aria-controls="ticket-setting" role="tab" data-toggle="tab"><spring:message code="step1.label.menu.setting"/></a></li>
				</ul>
				<div>
