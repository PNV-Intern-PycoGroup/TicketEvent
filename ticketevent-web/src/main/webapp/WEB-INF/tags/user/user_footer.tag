		...
		<div class="col-lg-12">
			<div class="row">
				...
				<div class="col-sm-6 col-md-3 fbody-block">
					...
					<div class="input-email input-group input-group-size fix-with-input">
						<span
				...
				<div class="col-sm-6 col-md-3 fbody-block">
					<div class="fbody-head lang-footer"><spring:message code="footer.labelInApp"/></div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-3">
					...
					<div>
						...
						<div class="social-media-fix">
							<div class="flag-vn">
								<a href='?lang=vi'> <img src="<%=request.getContextPath()%>/resources/icon/flag_vn.png"></img></a>
							</div>
							<div class="flag-en">
								<a href="?lang=en"> <img src="<%=request.getContextPath()%>/resources/icon/flag_en.png"></img></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-6">
			<div class="display-table">
				<div class="ft-img table-cell">
					<img src="<%=request.getContextPath()%>/resources/icon/logo2.png">
				</div>
				<div class="ftft-left">
